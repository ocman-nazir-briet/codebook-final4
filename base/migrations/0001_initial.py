    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('M', 'Male'), ('F', 'Female'), ('O', 'Other')], max_length=25)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('files', models.FileField(blank=True, upload_to='Room-files')),
                ('images', models.ImageField(blank=True, upload_to='Room-images')),
                ('video', models.FileField(blank=True, max_length=10000, upload_to='Room-videos')),
